...
struct EnvMap {
  ...
  bool setup_from_pixels(
    RHIContext& rhi, RHITextureFormat color_format, RHITextureFormat depth_format, const float4* pixels, const uint2& dimensions, uint32_t sample_count = 1u);
  bool setup_with_texture(
