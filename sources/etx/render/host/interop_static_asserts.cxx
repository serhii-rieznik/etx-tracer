...
static_assert((offsetof(::SpectralDistribution, spectral_entry_count) == kSpectralDistributionEntryCountOffset),
...
static_assert((offsetof(Material, scattering) + offsetof(SpectralImage, image_index)) == kMaterialScatteringImageIndexOffset,
  "Material::scattering.image_index offset changed");
...
static_assert(offsetof(Image, x_distribution_entries_offset) == kImageDescXDistributionEntriesOffset,
  "Image::x_distribution_entries_offset offset changed");
static_assert(offsetof(Image, y_distribution_entries_offset) == kImageDescYDistributionEntriesOffset,
  "Image::y_distribution_entries_offset offset changed");
...
static_assert(offsetof(Image, x_distribution_chunk_index) == kImageDescXDistributionChunkIndexOffset,
  "Image::x_distribution_chunk_index offset changed");
static_assert(offsetof(Image, y_distribution_chunk_index) == kImageDescYDistributionChunkIndexOffset,
  "Image::y_distribution_chunk_index offset changed");
...
static_assert(offsetof(MediumGrid, noise_border_fade_distance) == kMediumGridNoiseBorderFadeDistanceOffset,
  "MediumGrid::noise_border_fade_distance offset changed");
static_assert(offsetof(MediumGrid, density_data_chunk_index) == kMediumGridDensityDataChunkIndexOffset,
  "MediumGrid::density_data_chunk_index offset changed");
...
static_assert(offsetof(GPUSceneOptions, random_path_termination) == kSceneOptionsRandomPathTerminationOffset,
  "GPUSceneOptions::random_path_termination offset changed");
...
static_assert(offsetof(GPUImageBlobHeader, data_chunk_indices_offset) == kImageBlobHeaderDataChunkIndicesOffset,
  "GPUImageBlobHeader::data_chunk_indices_offset offset changed");
...
static_assert(offsetof(GPUMediumBlobHeader, data_chunk_indices_offset) == kMediumBlobHeaderDataChunkIndicesOffset,
  "GPUMediumBlobHeader::data_chunk_indices_offset offset changed");
...
static_assert((offsetof(etx::EmitterProfile, directional) + offsetof(etx::EmitterProfile::DirectionalData, direction)) ==
    kEmitterProfileDirectionalDirectionOffset,
  "EmitterProfile::directional.direction offset changed");
static_assert((offsetof(etx::EmitterProfile, directional) + offsetof(etx::EmitterProfile::DirectionalData, angular_size_cosine)) ==
