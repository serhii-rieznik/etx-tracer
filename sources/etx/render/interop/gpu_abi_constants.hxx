...
ETX_STATIC_CONST uint32_t kMaterialDiffractionGratingPeriodNmOffset = 192u;
ETX_STATIC_CONST uint32_t kMaterialDiffractionGratingOpticalPathDifferenceNmOffset = 196u;
ETX_STATIC_CONST uint32_t kMaterialDiffractionGratingDutyCycleOffset = 200u;
ETX_STATIC_CONST uint32_t kMaterialDiffractionGratingRotationOffset = 204u;
ETX_STATIC_CONST uint32_t kMaterialExtIorClassOffset = 208u;
ETX_STATIC_CONST uint32_t kMaterialExtIorEtaIndexOffset = 212u;
ETX_STATIC_CONST uint32_t kMaterialExtIorKIndexOffset = 216u;
ETX_STATIC_CONST uint32_t kMaterialIntIorClassOffset = 224u;
ETX_STATIC_CONST uint32_t kMaterialIntIorEtaIndexOffset = 228u;
ETX_STATIC_CONST uint32_t kMaterialIntIorKIndexOffset = 232u;
ETX_STATIC_CONST uint32_t kMaterialSubsurfaceClassOffset = 240u;
ETX_STATIC_CONST uint32_t kMaterialSubsurfacePathOffset = 244u;
ETX_STATIC_CONST uint32_t kMaterialClassOffset = 248u;
ETX_STATIC_CONST uint32_t kMaterialIntMediumOffset = 252u;
ETX_STATIC_CONST uint32_t kMaterialExtMediumOffset = 256u;
ETX_STATIC_CONST uint32_t kMaterialNormalImageIndexOffset = 260u;
ETX_STATIC_CONST uint32_t kMaterialTwoSidedOffset = 264u;
ETX_STATIC_CONST uint32_t kMaterialNormalScaleOffset = 268u;
ETX_STATIC_CONST uint32_t kMaterialOpacityOffset = 272u;
...
ETX_STATIC_CONST uint32_t kImageDescNormalizationOffset = 36u;
...
ETX_STATIC_CONST uint32_t kImageDescXEntriesStrideOffset = 76u;
ETX_STATIC_CONST uint32_t kImageDescXDistributionCountOffset = 80u;
ETX_STATIC_CONST uint32_t kImageDescYEntriesCountOffset = 84u;
ETX_STATIC_CONST uint32_t kImageDescYDistributionTotalWeightOffset = 88u;
ETX_STATIC_CONST uint32_t kImageDescPixelDataStrideOffset = 92u;
...
ETX_STATIC_CONST uint32_t kMediumGridDensityImageIndexOffset = 80u;
ETX_STATIC_CONST uint32_t kMediumBoundsMinOffset = 96u;
ETX_STATIC_CONST uint32_t kMediumBoundsMaxOffset = 112u;
ETX_STATIC_CONST uint32_t kMediumAbsorptionIndexOffset = 128u;
ETX_STATIC_CONST uint32_t kMediumScatteringIndexOffset = 132u;
...
ETX_STATIC_CONST uint32_t kSceneGlobalsDefaultBlackSpectrumOffset = 336u;
ETX_STATIC_CONST uint32_t kSceneGlobalsDefaultWhiteSpectrumOffset = 340u;
ETX_STATIC_CONST uint32_t kSceneGlobalsDefaultSubsurfaceScatterMaterialOffset = 356u;
ETX_STATIC_CONST uint32_t kSceneGlobalsDefaultSubsurfaceExitMaterialOffset = 360u;
ETX_STATIC_CONST uint32_t kSceneGlobalsDefaultDielectricEtaOffset = 368u;
ETX_STATIC_CONST uint32_t kSceneGlobalsDefaultConductorEtaOffset = 372u;
