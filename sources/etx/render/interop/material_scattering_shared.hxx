...
ETX_SHARED_INLINE SpectralResponse material_scattering_shared_apply_spectral(ETX_IN(SpectralQuery, spect), ETX_IN(SpectralResponse, value), ETX_IN(float3, image_rgb),
  bool apply_image) {
...
ETX_SHARED_INLINE SpectralResponse material_scattering_shared_apply_spectral_clamped_ao(ETX_IN(SpectralQuery, spect), ETX_IN(SpectralResponse, value), ETX_IN(float3, image_rgb),
  bool apply_image, float ao) {
