...
#else
BSDFEval wavefront_connect_camera_stage_bsdf_eval(
...
[numthreads(64, 1, 1)] void ETX_STAGE_ENTRY(uint3 dtid : SV_DispatchThreadID) {
  ...
  BSDFEval bsdf_eval = wavefront_connect_camera_stage_bsdf_eval(
    wavefront_connect_camera_make_scene_bsdf_resource_gpu_context(), bsdf_data, input_value.camera_sample.direction, input_value.material, bsdf_sampler);
