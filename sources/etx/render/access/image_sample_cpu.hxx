...
ETX_SHARED_INLINE bool image_sample_try_sample(
  ETX_IN(ImageSampleCPUContext, context), uint32_t image_index, ETX_IN(float2, rnd), ETX_OUT(ImageSampleAccess, sample)) {
