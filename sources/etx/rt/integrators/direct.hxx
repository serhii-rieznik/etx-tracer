...
struct CPUDirectLighting : public Integrator {
  CPUDirectLighting(Raytracing&);
  ~CPUDirectLighting() override;

  const char* name() override {
    return "Direct Lighting (CPU)";
  }
  ...
  ETX_DECLARE_PIMPL(CPUDirectLighting, 4096);
};
